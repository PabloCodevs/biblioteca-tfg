...
public class UsuarioServiceImpl implements UsuarioService {
     ...
     *
     * <p>Si el usuario no existe, se devuelve {@link java.util.Optional#empty()}.
     * Si existe, se devuelve {@link java.util.Optional} con su lista de libros (puede estar vacía).</p>
     *
     * @param usuarioId identificador del usuario cuyo listado de préstamos se solicita; puede ser {@code null}.
     * @return {@link java.util.Optional} con la lista de {@link Libro} asociados al usuario,
     *         o {@code Optional.empty()} si el usuario no existe.
     */
    @Override
